...
import javax.swing.*;
public class EmployeeQ5 extends JFrame {
...
//	}
	...
	public EmployeeQ5() {
		...
		JLabel lblListOfPatients = new JLabel("List of Patients treated by a doctor");
		
		lblListOfPatients.setFont(new Font("Serif", Font.PLAIN, 40));
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					db.connectToDB();
					db.employeeq5(textField, textField_1, textArea, contentPane);
					db.close();
				} catch (Exception e1) {
